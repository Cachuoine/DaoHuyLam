...
local Config = {
    ...
    -- Màu cố định cho dòng chạy
    MarqueeUserColor = Color3.fromRGB(0, 150, 255),      -- Xanh lam
    MarqueeExecutorColor = Color3.fromRGB(168, 85, 247), -- Tím
    MarqueeCreColor = Color3.fromRGB(255, 75, 75),       -- Đỏ
